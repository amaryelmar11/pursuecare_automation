...
public class Patient_List_Page extends Baseclass{
    ...
    Thread.sleep(3000);
     ...
     cu.enterText(pc.add_pat_Email, createdPatientEmail);
       Thread.sleep(2000);
        ...
        Thread.sleep(3000);
        pc.BlockclickDateAfterXDaysPASCM(driver, 0, "M/dd/yyyy");
        ((JavascriptExecutor) driver).executeScript("arguments[0].dispatchEvent(new KeyboardEvent('keydown', {'key': 'Enter'}));");
